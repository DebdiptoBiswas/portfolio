...
export const education = [
  ...
  },
  {
    ...
    grade: "94.6%",
    desc: "I completed my class 12 high school education at Delhi Public School, Bokaro Steel City, where I studied Science.",
  ...
  },
  {
    ...
    grade: "96.4%",
    desc: "I completed my class 10 education at Delhi Public School, Bokaro Steel City.",
    degree: "CBSE(X)",
  },
];
...
export const projects = [
  {
    ...
    description:
      "Inspired from Tinder website. A Tinder clone Made using HTML,CSS,Bootstrap",
  ...
  },
  {
    ...
    description:
      "A click operated drumming website using js, css, html",
  ...
  },
  {
    ...
    description:
      "A dice roll website made using html, css, js for two players",
...

  {
    ...
    description:
      "A web designing agency website made using HTML, CSS, advanced flexbox and media query",
    tags: [
      "Bootstrap", "HTML", "CSS"],
    category: "Bootstrap",
